...
- Name: smoke.spec.ts >> Smoke Tests >> should load Regreso page
...
Locator: locator('h1')
Expected pattern: /Regresa|Come Home/i
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1')
    2 × waiting for" http://localhost:3005/es/puro-surf/regreso" navigation to finish...
      - navigated to "http://localhost:3005/es/puro-surf/regreso"

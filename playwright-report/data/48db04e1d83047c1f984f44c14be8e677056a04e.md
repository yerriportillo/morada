...
- Name: smoke.spec.ts >> Smoke Tests >> should load operator landing page (Puro Surf)
...
Call log:
  ...
  - waiting for locator('h1')
    3 × waiting for" http://localhost:3005/es/puro-surf" navigation to finish...
      - navigated to "http://localhost:3005/es/puro-surf"

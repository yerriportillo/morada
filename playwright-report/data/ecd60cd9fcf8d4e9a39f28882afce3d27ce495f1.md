...
- Name: smoke.spec.ts >> Smoke Tests >> should load the homepage in English
...
Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    4 × unexpected value ""
    3 × waiting for" http://localhost:3005/en" navigation to finish...
      - navigated to "http://localhost:3005/en"
      - unexpected value ""

...
- Name: smoke.spec.ts >> Smoke Tests >> should navigate between languages
- Location: e2e/smoke.spec.ts:50:7

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://localhost:3005/es
Call log:
  - navigating to "http://localhost:3005/es", waiting until "load"
